...
export const menus = [
  { id: 1, name: "Breakfast", bgColor: "#b73e3e" ,icon: "🍲", items: startersItem },
  { id: 2, name: "Lunch", bgColor: "#5b45b0" ,icon: "🍛", items: mainCourse },
  { id: 3, name: "Dinner", bgColor: "#7f167f" ,icon: "🍹", items: mainCourse },
  { id: 4, name: "Soups", bgColor: "#735f32" ,icon: "🍜", items: soups },
  { id: 5, name: "Juice", bgColor: "#1d2569" ,icon: "🍰", items: beverages },
  { id: 6, name: "Beverages", bgColor: "#285430" ,icon: "🍕", items: beverages },
...
export const metricsData = [
  { title: "Revenue", value: "Tsh 50,846.90", percentage: "12%", color: "#025cca", isIncrease: false },
