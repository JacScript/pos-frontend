...
const BottomNav = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-[#262626] h-16 flex justify-around items-center px-2 
      md:justify-evenly md:h-18 lg:h-20 flex-wrap">
      
      {/* Home Button */}
      <button
        onClick={() => history.push("/")}
        aria-label="Home"
        className={`flex max-md:flex-col items-center p-2 text-sm sm:text-base ${
          isActive("/") ? "bg-[#f6b100] text-white rounded-lg px-3 py-1" : "text-[#f5f5f5]"
        }`}
      >
        <FaHome className="max-md:mr-0 mr-2" size={20} />
      ...
      <button
        ...
        aria-label="Orders"
        className={`flex max-md:flex-col items-center p-2 text-sm sm:text-base ${
          isActive("/orders") ? "bg-[#f6b100] text-white rounded-lg px-3 py-1" : "text-[#ababab]"
        }`}
      >
        <MdOutlineReorder className="max-md:mr-0 mr-2" size={20} />
        <p className="max-md:text-xs">Orders</p>
      </button>
      ...
      <button
        ...
        aria-label="Tables"
        className={`flex max-md:flex-col items-center p-2 text-sm sm:text-base ${
          isActive("/tables") ? "bg-[#f6b100] text-white rounded-lg px-3 py-1" : "text-[#ababab]"
        }`}
      >
        <MdTableBar className="max-md:mr-0 mr-2" size={20} />
        <p className="max-md:text-xs">Tables</p>
      </button>
      ...
      <button
        aria-label="Others"
        className={`flex max-md:flex-col items-center p-2 text-sm sm:text-base ${
          isActive("/others") ? "bg-[#f6b100] text-white rounded-lg px-3 py-1" : "text-[#ababab]"
        }`}
      >
        <CiCircleMore  className="max-md:mr-0 mr-2" size={20} />
        <p className="max-md:text-xs">Others</p>
      </button>
      ...
      <button
        ...
        onClick={openModal}
        aria-label="Menu"
        className="absolute bottom-16 sm:bottom-14 left-1/2 transform -translate-x-1/2 
          p-3 bg-[#f6b100] text-[#f5f5f5] rounded-full shadow-lg w-12 h-12 sm:w-14 sm:h-14"
      >
        <BiSolidDish size={30} />
      </button>
      ...
      <Modal isOpen={isModalOpen} onClose={closeModal} title="Create Order">
        <div className="mb-4">
          <label className="block text-[#ababab] mb-1 text-sm font-medium">Customer Name</label>
          <input
            value={name}
            onChange={(e) => setName(e.target.value)}
            type="text"
            placeholder="Enter customer name"
            className="w-full p-2 border border-[#333] rounded-lg bg-transparent text-white focus:outline-none"
          />
        </div>
        <div className="mb-4">
          <label className="block text-[#ababab] mb-1 text-sm font-medium">Customer Phone</label>
          <input
            value={phone}
            onChange={(e) => setPhone(e.target.value)}
            type="number"
        ...
        <div>
          <label className="block text-[#ababab] mb-1 text-sm font-medium">Guest</label>
          <div className="flex items-center justify-between bg-[#1f1f1f] px-4 py-3 rounded-lg">
            <button onClick={decrement} className="text-yellow-500 text-2xl font-bold">
              &minus;
            </button>
